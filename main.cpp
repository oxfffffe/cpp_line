...
//	std::cout << "concatenate first string with itself: \t" << a + a << std::endl;			// [!!!] UNDEFINED BEHAVIOR
	std::cout << "first string == itself: \t\t" << (a == a) << std::endl;
	std::cout << "first string != itself: \t\t" << (a != a) << std::endl;
	std::cout << "first string == \"123\": \t\t\t" << (a == "123") << std::endl;
	std::cout << "first string != \"123\": \t\t\t" << (a != "123") << std::endl;
	std::cout << "match text (regex): \t\t\t" << Regex::match_exists(".*regex.*", a) << std::endl;
#endif//__DEBUG_LINE
#ifdef	__DEBUG_REGEX
